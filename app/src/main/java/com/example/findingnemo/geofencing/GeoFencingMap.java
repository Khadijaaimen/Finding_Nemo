...
//        memberNumber = getIntent().getIntExtra("memberCount", 0);
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        try {
            if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(GeoFencingMap.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 101);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(GeoFencingMap.this, MyNavigationActivity.class);
